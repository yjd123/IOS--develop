...
@class XCFGoods,XCFHeaderImageView,XCFGoodsDetailView,XCFGoodsBottomView,XCFGoodsReviewView,XCFGoodsImageTextView,XCFKindsCategoryView;
...
@property(nonatomic,strong)XCFGoodsImageTextView *textView;

@property(nonatomic,strong)XCFKindsCategoryView *kindsView;
