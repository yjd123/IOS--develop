 ...
 */
typedef enum {
    XCFCellTemplateTopic = 9,           // 帖子
    XCFCellTemplateRecipeList = 2,      // 菜单
    XCFCellTemplatewhisper = 4,          // 最后一页
    XCFCellTemplateTalk = 1,            // 聊天
 ...
 */
typedef enum {
    XCFRecipeCellFontSizeTitle = 14,        // 标题
    XCFRecipeCellFontSizeDesc = 11,         // 描述
    XCFRecipeCellFontSizeFirstTitle = 17,   // 大标题
    XCFRecipeCellFontSizeSecondTitle = 12   // 小标题
...
typedef NS_ENUM(NSInteger, BottomViewClicked) {
    ...
    BottomViewClickedGoToTalk          // 联系卖家
};
